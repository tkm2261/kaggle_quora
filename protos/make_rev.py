...
def train_data():
    ...
    with open('../fasttext/fast_train_clean2_low.pkl', 'rb') as f:
        x = pickle.load(f).astype(np.float32)
    x = calc(x)
    with open('../fasttext/fast_train_clean2_low2_rev.pkl', 'wb') as f:
        pickle.dump(x, f, -1)

    with open('../fasttext/fast_train_clean2_low_max.pkl', 'rb') as f:
        x = pickle.load(f).astype(np.float32)
    x = calc(x)
    with open('../fasttext/fast_train_clean2_low_max2_rev.pkl', 'wb') as f:
        pickle.dump(x, f, -1)
    """
    ...
    with open('../glove/glove_train_clean.pkl', 'rb') as f:
        x = pickle.load(f).astype(np.float32)
    x = calc(x)
    with open('../glove/glove_train_clean2_rev.pkl', 'wb') as f:
        pickle.dump(x, f, -1)

    with open('../glove/glove_train_clean_max.pkl', 'rb') as f:
        x = pickle.load(f).astype(np.float32)
    x = calc(x)
    with open('../glove/glove_train_clean_max2_rev.pkl', 'wb') as f:
        pickle.dump(x, f, -1)
    """
    """        
...
def test_data():
    ...
    with open('../glove/glove_test_clean.pkl', 'rb') as f:
        x = pickle.load(f).astype(np.float32)
    x = calc(x)
    with open('../glove/glove_test_clean2_rev.pkl', 'wb') as f:
        pickle.dump(x, f, -1)

    with open('../glove/glove_test_clean_max.pkl', 'rb') as f:
        x = pickle.load(f).astype(np.float32)
    x = calc(x)
    with open('../glove/glove_test_clean_max2_rev.pkl', 'wb') as f:
        pickle.dump(x, f, -1)
    ...
    with open('../fasttext/fast_test_clean2_low.pkl', 'rb') as f:
        x = pickle.load(f).astype(np.float32)
    x = calc(x)
    with open('../fasttext/fast_test_clean2_low2_rev.pkl', 'wb') as f:
        pickle.dump(x, f, -1)

    with open('../fasttext/fast_test_clean2_low_max.pkl', 'rb') as f:
        x = pickle.load(f).astype(np.float32)
    x = calc(x)
    with open('../fasttext/fast_test_clean2_low_max2_rev.pkl', 'wb') as f:
        pickle.dump(x, f, -1)

    """
    logger.info('3')
    x = pd.read_csv('lsi_test.csv').values.astype(np.float32)
    x = calc(x)
    with open('lsi_test.pkl', 'wb') as f:
        pickle.dump(x, f, -1)
