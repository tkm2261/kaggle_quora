...
def load_data(row):
    ...
    list_ret = [num_ent, num_ent2, num_clean2_rev, num_for, lev_dist, jar_dist, dam_dist,
                num_sub, num_root, num_advmod, num_advcl, num_aux,  # num_poss,
                num_noun, num_verb, num_adv,  # num_adj,
                num_svo, num_s, num_v, num_o]
    list_ret += [val_ent, val_ent2, val_clean2_rev, val_for,
...
if __name__ == '__main__':
    ...
    print(ret[:100])
    with open('train_svo3.pkl', 'wb') as f:
        pickle.dump(ret, f, -1)
