...
with open('map_wordvec_glove.pkl', 'wb') as f:
    pickle.dump(map_wordvec, f, -1)
"""
with open('map_wordvec_glove.pkl', 'rb') as f:
...
def make_data():
    ...
    #df_vec.to_csv('doc_vec.csv', index=False)
    with open('glove_vec_test.pkl', 'wb') as f:
        pickle.dump(df_vec, f, -1)
...
if __name__ == '__main__':
    ...
    with open('glove_train_clean2.pkl', 'wb') as f:
